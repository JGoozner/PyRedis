...
class ProtocolHandler(object):
    ...
    def handle_request(self, socket_file):
        #function to parse the first byte and input into the proper function

        #Disconnects if first byte does not exist
        ...
        try:
            ...
            return self.handlers[first_byte]
        except KeyError:
...
class Server(object):
    def __init__(self, host="192.168.0.27", port=31337, max_clients=64):
    ...
    def get_response(self, data):
        ...
        if command not in self_.commands:
    ...
    def get_response(self, data):
        #Unpack the data sent by the client; execute the command; and pass return value
        pass
...
class CLient(object):
    def __init__(self, host="192.168.0.27", port=31337):
       self._protocol = ProtocolHandler()
...
def client_tests():
    ...
    print("End of client tests")
    pass

print(__name__)
#Code below is for testing/debugging
